defmodule OpenAI do
  ...
  **NOTE:** At the time of this writing this functionality remains undocumented by OpenAI.
  ...
  """
  def vector_stores_create(params, config \\ %Config{}) do
  ...
  Get a vector store.
  """
  def vector_stores(vector_store_id, config) do
    VectorStores.fetch(vector_store_id, config)
  end

  @doc """
  List vector stores.
  """
  def vector_stores(config \\ %Config{}) do
    VectorStores.fetch(config)
  end

  @doc """
  Delete a vector store.
  """
  def vector_stores_delete(vector_store_id, config \\ %Config{}) do
  ...
  """
  def vector_stores_files_create(vector_store_id, file_path, config \\ %Config{}) do
    VectorStores.Files.create(vector_store_id, file_path, config)
  end
  ...
  """
  def vector_stores_files_list(vector_store_id, config \\ %Config{}) do
    VectorStores.Files.fetch(vector_store_id, config)
  end

  @doc """
  Delete vector store file.
  """
  def vector_stores_files_delete(vector_store_id, file_id, config \\ %Config{}) do
    VectorStores.Files.delete(vector_store_id, file_id, config)
  end
end
